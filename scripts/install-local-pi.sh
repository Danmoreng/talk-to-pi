...
echo "Add this export to your shell profile for the local runtime:"
printf '  export TALK_TO_PI_RUNTIME_PATH=%q\n' "$RUNTIME_PATH"
echo "The first /talk invocation asks permission to download the official NVIDIA model into the Hugging Face cache."
echo
